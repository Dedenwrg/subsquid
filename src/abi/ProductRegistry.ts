...
export const functions = {
    ...
    offerPriceBuffer: new Func<[productId: string], {productId: string}, bigint>(
        abi, '0x808c0869'
    ),
...
export class Contract extends ContractBase {
    ...
    offerPriceBuffer(productId: string): Promise<bigint> {
        return this.eth_call(functions.offerPriceBuffer, [productId])
    }
