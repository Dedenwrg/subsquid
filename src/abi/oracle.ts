...
export const events = {
  ...
  CommitRevealMissed: new LogEvent<
    [_voter: string, _round: bigint, _nonRevealCount: bigint] & {
      _voter: string;
      _round: bigint;
      _nonRevealCount: bigint;
    }
  ...
  InvalidVote: new LogEvent<
    [cause: string, reporter: string, expValue: bigint, actualValue: bigint, extra: number] & {
      cause: string;
      reporter: string;
      expValue: bigint;
      actualValue: bigint;
  ...
  NewRound: new LogEvent<
    [_round: bigint, _timestamp: bigint, _votePeriod: bigint] & {
      _round: bigint;
      _timestamp: bigint;
      _votePeriod: bigint;
    }
  >(abi, '0x5aec57d81928b24d30b1a2aec0d23d693412c37d7ec106b5d8259413716bb1f4'),
  NewSymbols: new LogEvent<
    [_symbols: Array<string>, _round: bigint] & { _symbols: Array<string>; _round: bigint }
  ...
  NewVoter: new LogEvent<[reporter: string, extra: number] & { reporter: string; extra: number }>(
    abi,
    '0xd2ec8e890a03083998d3e16f98044fd3dd13fe3e61b7bc2e58ee6da43b50af73',
  ),
  NoRevealPenalty: new LogEvent<
    [_voter: string, _round: bigint, _missedReveal: bigint] & {
      _voter: string;
      _round: bigint;
      _missedReveal: bigint;
    }
  >(abi, '0x9e6b40f10c60d1ad09594f3b6ed7043d0e978f584d354ace6e1f6025660c42b1'),
  Penalized: new LogEvent<
    [
      _participant: string,
      _slashingAmount: bigint,
      _symbol: string,
      _median: bigint,
      _reported: bigint,
    ] & {
  ...
  PriceUpdated: new LogEvent<
    [price: bigint, round: bigint, symbol: string, status: boolean, timestamp: bigint] & {
      price: bigint;
      round: bigint;
      symbol: string;
      status: boolean;
  ...
  SuccessfulVote: new LogEvent<
    [reporter: string, extra: number] & { reporter: string; extra: number }
  >(abi, '0x8bdddd7f2f2c74679ffa6beb8f86aa18bfa5baf1bfaf534d0b66596babc53f08'),
  TotalOracleRewards: new LogEvent<
    [ntnReward: bigint, atnReward: bigint] & { ntnReward: bigint; atnReward: bigint }
  >(abi, '0x3e5aaff9e8fd4293ae18127809c2d4069d87fe10c7de92aa39557a1edbd48fec'),
};

export const functions = {
  distributeRewards: new Func<[_ntn: bigint], { _ntn: bigint }, []>(abi, '0x59974e38'),
  finalize: new Func<[], {}, boolean>(abi, '0x4bb278f3'),
  getConfig: new Func<
    [],
    {},
    [
  ...
  >(abi, '0xc3f909d4'),
  getDecimals: new Func<[], {}, number>(abi, '0xf0141d84'),
  getLastRoundBlock: new Func<[], {}, bigint>(abi, '0x5a4d3a27'),
  getNewVotePeriod: new Func<[], {}, bigint>(abi, '0x57eba759'),
  getNewVoters: new Func<[], {}, Array<string>>(abi, '0x077945d3'),
  getNonRevealThreshold: new Func<[], {}, bigint>(abi, '0xed78349d'),
  getReports: new Func<
    [_symbol: string, _voter: string],
    { _symbol: string; _voter: string },
    [price: bigint, confidence: number] & { price: bigint; confidence: number }
  >(abi, '0xfb09917e'),
  getRewardPeriodPerformance: new Func<[_voter: string], { _voter: string }, bigint>(
    abi,
    '0x33d16293',
  ),
  getRound: new Func<[], {}, bigint>(abi, '0x9f8743f7'),
  getRoundData: new Func<
    [_round: bigint, _symbol: string],
    { _round: bigint; _symbol: string },
  ...
  >(abi, '0x3c8510fd'),
  getSymbolUpdatedRound: new Func<[], {}, bigint>(abi, '0x99b0014b'),
  getSymbols: new Func<[], {}, Array<string>>(abi, '0xdf7f710e'),
  getVotePeriod: new Func<[], {}, bigint>(abi, '0xb78dec52'),
  getVoterInfo: new Func<
    [_voter: string],
    { _voter: string },
    [
      round: bigint,
  ...
  getVoters: new Func<[], {}, Array<string>>(abi, '0xcdd72253'),
  latestRoundData: new Func<
    [_symbol: string],
    { _symbol: string },
    [round: bigint, price: bigint, timestamp: bigint, success: boolean] & {
      round: bigint;
  ...
  >(abi, '0x33f98c77'),
  setCommitRevealConfig: new Func<
    [_threshold: bigint, _resetInterval: bigint],
    { _threshold: bigint; _resetInterval: bigint },
    []
  >(abi, '0x3f422ef3'),
  setOperator: new Func<[_operator: string], { _operator: string }, []>(abi, '0xb3ab15fb'),
  setSlashingConfig: new Func<
    [
      _outlierSlashingThreshold: bigint,
      _outlierDetectionThreshold: bigint,
      _baseSlashingRate: bigint,
      _slashingRateCap: bigint,
    ],
    {
      _outlierSlashingThreshold: bigint;
      _outlierDetectionThreshold: bigint;
  ...
  setVotePeriod: new Func<[_votePeriod: bigint], { _votePeriod: bigint }, []>(abi, '0x67b11630'),
  setVoters: new Func<
    [_newVoters: Array<string>, _treasury: Array<string>, _validator: Array<string>],
    { _newVoters: Array<string>; _treasury: Array<string>; _validator: Array<string> },
    []
  >(abi, '0xda78110e'),
  updateVotersAndSymbol: new Func<[], {}, []>(abi, '0x0f65875c'),
  vote: new Func<
    [
      _commit: bigint,
      _reports: Array<[price: bigint, confidence: number] & { price: bigint; confidence: number }>,
      _salt: bigint,
      _extra: number,
    ],
    {
...
export class Contract extends ContractBase {
  ...
  getReports(
    _symbol: string,
    _voter: string,
  ): Promise<[price: bigint, confidence: number] & { price: bigint; confidence: number }> {
