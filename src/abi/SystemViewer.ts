...
export const functions = {
    ...
    maeChecks: new Func<[accounts: Array<string>, settlements: Array<([productId: string, quantity: bigint, price: bigint] & {productId: string, quantity: bigint, price: bigint})>], {accounts: Array<string>, settlements: Array<([productId: string, quantity: bigint, price: bigint] & {productId: string, quantity: bigint, price: bigint})>}, ([results: Array<boolean>, maeAfter: Array<bigint>, mmuAfter: Array<bigint>] & {results: Array<boolean>, maeAfter: Array<bigint>, mmuAfter: Array<bigint>})>(
        abi, '0x8620dc7c'
    ),
    ...
    positionQuantitiesByProductId: new Func<[productId: string, accounts: Array<string>], {productId: string, accounts: Array<string>}, Array<bigint>>(
        abi, '0x09cddc62'
    ),
    positionQuantitiesByProductIds: new Func<[productIds: Array<string>, accounts: Array<string>], {productIds: Array<string>, accounts: Array<string>}, Array<bigint>>(
        abi, '0xe457690b'
    ),
    positionsByCollateralAsset: new Func<[collateralAsset: string, accounts: Array<string>], {collateralAsset: string, accounts: Array<string>}, Array<Array<([productId: string, quantity: bigint, costBasis: bigint, maintenanceMargin: bigint, pnl: bigint] & {productId: string, quantity: bigint, costBasis: bigint, maintenanceMargin: bigint, pnl: bigint})>>>(
        abi, '0x56893fd5'
    ),
    positionsByCollateralAssets: new Func<[collateralAssets: Array<string>, accounts: Array<string>], {collateralAssets: Array<string>, accounts: Array<string>}, Array<Array<([productId: string, quantity: bigint, costBasis: bigint, maintenanceMargin: bigint, pnl: bigint] & {productId: string, quantity: bigint, costBasis: bigint, maintenanceMargin: bigint, pnl: bigint})>>>(
        abi, '0xcb674f3e'
    ),
    productDetails: new Func<[productIds: Array<string>], {productIds: Array<string>}, Array<([base: ([metadata: ([builder: string, symbol: string, description: string] & {builder: string, symbol: string, description: string}), oracleSpec: ([oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string] & {oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string}), collateralAsset: string, startTime: bigint, pointValue: bigint, priceDecimals: number, extendedMetadata: string] & {metadata: ([builder: string, symbol: string, description: string] & {builder: string, symbol: string, description: string}), oracleSpec: ([oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string] & {oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string}), collateralAsset: string, startTime: bigint, pointValue: bigint, priceDecimals: number, extendedMetadata: string}), expirySpec: ([earliestFSPSubmissionTime: bigint, tradeoutInterval: bigint] & {earliestFSPSubmissionTime: bigint, tradeoutInterval: bigint}), maxPrice: bigint, minPrice: bigint] & {base: ([metadata: ([builder: string, symbol: string, description: string] & {builder: string, symbol: string, description: string}), oracleSpec: ([oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string] & {oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string}), collateralAsset: string, startTime: bigint, pointValue: bigint, priceDecimals: number, extendedMetadata: string] & {metadata: ([builder: string, symbol: string, description: string] & {builder: string, symbol: string, description: string}), oracleSpec: ([oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string] & {oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string}), collateralAsset: string, startTime: bigint, pointValue: bigint, priceDecimals: number, extendedMetadata: string}), expirySpec: ([earliestFSPSubmissionTime: bigint, tradeoutInterval: bigint] & {earliestFSPSubmissionTime: bigint, tradeoutInterval: bigint}), maxPrice: bigint, minPrice: bigint})>>(
        abi, '0xf2391a3a'
    ),
    ...
    userMarginDataByCollateralAsset: new Func<[collateralAsset: string, accounts: Array<string>], {collateralAsset: string, accounts: Array<string>}, Array<([collateralAsset: string, marginAccountId: string, mae: bigint, mmu: bigint, positions: Array<([productId: string, quantity: bigint, costBasis: bigint, maintenanceMargin: bigint, pnl: bigint] & {productId: string, quantity: bigint, costBasis: bigint, maintenanceMargin: bigint, pnl: bigint})>] & {collateralAsset: string, marginAccountId: string, mae: bigint, mmu: bigint, positions: Array<([productId: string, quantity: bigint, costBasis: bigint, maintenanceMargin: bigint, pnl: bigint] & {productId: string, quantity: bigint, costBasis: bigint, maintenanceMargin: bigint, pnl: bigint})>})>>(
        abi, '0xa4c96e68'
    ),
...
export class Contract extends ContractBase {
    ...
    maeChecks(accounts: Array<string>, settlements: Array<([productId: string, quantity: bigint, price: bigint] & {productId: string, quantity: bigint, price: bigint})>): Promise<([results: Array<boolean>, maeAfter: Array<bigint>, mmuAfter: Array<bigint>] & {results: Array<boolean>, maeAfter: Array<bigint>, mmuAfter: Array<bigint>})> {
        return this.eth_call(functions.maeChecks, [accounts, settlements])
    }
    ...
    positionQuantitiesByProductId(productId: string, accounts: Array<string>): Promise<Array<bigint>> {
        return this.eth_call(functions.positionQuantitiesByProductId, [productId, accounts])
    }

    positionQuantitiesByProductIds(productIds: Array<string>, accounts: Array<string>): Promise<Array<bigint>> {
        return this.eth_call(functions.positionQuantitiesByProductIds, [productIds, accounts])
    }

    positionsByCollateralAsset(collateralAsset: string, accounts: Array<string>): Promise<Array<Array<([productId: string, quantity: bigint, costBasis: bigint, maintenanceMargin: bigint, pnl: bigint] & {productId: string, quantity: bigint, costBasis: bigint, maintenanceMargin: bigint, pnl: bigint})>>> {
        return this.eth_call(functions.positionsByCollateralAsset, [collateralAsset, accounts])
    }

    positionsByCollateralAssets(collateralAssets: Array<string>, accounts: Array<string>): Promise<Array<Array<([productId: string, quantity: bigint, costBasis: bigint, maintenanceMargin: bigint, pnl: bigint] & {productId: string, quantity: bigint, costBasis: bigint, maintenanceMargin: bigint, pnl: bigint})>>> {
        return this.eth_call(functions.positionsByCollateralAssets, [collateralAssets, accounts])
    }

    productDetails(productIds: Array<string>): Promise<Array<([base: ([metadata: ([builder: string, symbol: string, description: string] & {builder: string, symbol: string, description: string}), oracleSpec: ([oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string] & {oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string}), collateralAsset: string, startTime: bigint, pointValue: bigint, priceDecimals: number, extendedMetadata: string] & {metadata: ([builder: string, symbol: string, description: string] & {builder: string, symbol: string, description: string}), oracleSpec: ([oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string] & {oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string}), collateralAsset: string, startTime: bigint, pointValue: bigint, priceDecimals: number, extendedMetadata: string}), expirySpec: ([earliestFSPSubmissionTime: bigint, tradeoutInterval: bigint] & {earliestFSPSubmissionTime: bigint, tradeoutInterval: bigint}), maxPrice: bigint, minPrice: bigint] & {base: ([metadata: ([builder: string, symbol: string, description: string] & {builder: string, symbol: string, description: string}), oracleSpec: ([oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string] & {oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string}), collateralAsset: string, startTime: bigint, pointValue: bigint, priceDecimals: number, extendedMetadata: string] & {metadata: ([builder: string, symbol: string, description: string] & {builder: string, symbol: string, description: string}), oracleSpec: ([oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string] & {oracleAddress: string, fsvDecimals: number, fspAlpha: bigint, fspBeta: bigint, fsvCalldata: string}), collateralAsset: string, startTime: bigint, pointValue: bigint, priceDecimals: number, extendedMetadata: string}), expirySpec: ([earliestFSPSubmissionTime: bigint, tradeoutInterval: bigint] & {earliestFSPSubmissionTime: bigint, tradeoutInterval: bigint}), maxPrice: bigint, minPrice: bigint})>> {
